...
- [x] GitHub 저장소에 `.github/workflows/verify.yml`을 push해 원격 CI 검증 완료. 코드 검증 run `35186294695`(commit `074bf12`)과 문서 반영 run `35186462305`(commit `4cba20f`)에서 회귀 98개를 포함한 검증이 성공했다. 보호 규칙 연결은 GitHub 저장소 설정에서 별도 결정.
